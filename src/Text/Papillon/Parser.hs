...
p_nameLeaf_ = foldl1 mplus [do xx60_60 <- dvCharsM
                            ...
                            do xx61_61 <- dvCharsM
                               ...
                               if isAmp c
                                then return ()
                                else throwErrorPackratM "isAmp c" "not match"
                               nl <- dv_nameLeafM
                               return ()
                               if True then return () else throwErrorPackratM "True" "not match"
                               return (After nl),
...
p_patOp = foldl1 mplus [do p <- dv_patM
                        ...
                        do p <- dv_patM
                           ...
                           if isBQ q
                            then return ()
                            else throwErrorPackratM "isBQ q" "not match"
                           t <- dv_typM
                           return ()
                           if True then return () else throwErrorPackratM "True" "not match"
                           xx64_64 <- dvCharsM
                           ...
                           if isBQ q_
                            then return ()
                            else throwErrorPackratM "isBQ q_" "not match"
                           dv_spacesM >> return ()
                           if True then return () else throwErrorPackratM "True" "not match"
                           po <- dv_patOpM
                           return ()
...
p_patList = foldl1 mplus [do p <- dv_patOpM
                          ...
                          do p <- dv_patOpM
                             ...
                             return [p],
                          do return []]
p_opConName = foldl1 mplus [do xx78_78 <- dvCharsM
                               case xx78_78 of
                                   ':' -> return ()
                                   _ -> throwErrorPackratM "':'" "not match pattern"
                               let ':' = xx78_78
...
p_charLit = foldl1 mplus [do xx79_79 <- dvCharsM
                             let c = xx79_79
                             if isAlphaNumOt c
                              then return ()
                          ...
                          do xx80_80 <- dvCharsM
                             ...
                             return (getNTs c)]
p_stringLit = foldl1 mplus [do ddd82_82 <- get
                               ...
                               return (cons c s),
                            do return emp]
p_dq = foldl1 mplus [do xx84_84 <- dvCharsM
                        case xx84_84 of
                            '"' -> return ()
                            _ -> throwErrorPackratM "'\"'" "not match pattern"
                        let '"' = xx84_84
...
p_leaf = foldl1 mplus [do t <- dv_testM
                       ...
                       do rf <- dv_readFromLsM
                          ...
                          if True then return () else throwErrorPackratM "True" "not match"
                          return (rf, true)]
p_readFromLs = foldl1 mplus [do rf <- dv_readFromM
                                return ()
                                if True then return () else throwErrorPackratM "True" "not match"
                                xx85_85 <- dvCharsM
                                case xx85_85 of
                             ...
                             do rf <- dv_readFromM
                                ...
                                if True then return () else throwErrorPackratM "True" "not match"
                                return rf]
p_readFrom = foldl1 mplus [do v <- dv_variableM
                              return ()
                              if True then return () else throwErrorPackratM "True" "not match"
...
p_test = foldl1 mplus [do xx90_90 <- dvCharsM
                          case xx90_90 of
                              '[' -> return ()
                              _ -> throwErrorPackratM "'['" "not match pattern"
                          let '[' = xx90_90
                          ...
                          if True then return () else throwErrorPackratM "True" "not match"
                          return h]
p_hsExpLam = foldl1 mplus [do xx92_92 <- dvCharsM
                              case xx92_92 of
                                  '\\' -> return ()
                                  _ -> throwErrorPackratM "'\\\\'" "not match pattern"
                              let '\\' = xx92_92
...
p_hsExpOp = foldl1 mplus [do l <- dv_hsExpM
                          ...
                          do e <- dv_hsExpM
                             ...
                             if True then return () else throwErrorPackratM "True" "not match"
                             return (getEx e)]
p_hsOp = foldl1 mplus [do xx97_97 <- dvCharsM
                          let c = xx97_97
                          if isOpHeadChar c
                           then return ()
                       ...
                       do xx98_98 <- dvCharsM
                          ...
                          if True then return () else throwErrorPackratM "True" "not match"
                          ddd99_99 <- get
                          flipMaybe (do xx100_100 <- dvCharsM
                                        case xx100_100 of
                                            ':' -> return ()
                                            _ -> throwErrorPackratM "':'" "not match pattern"
                                        let ':' = xx100_100
                       ...
                       do xx101_101 <- dvCharsM
                          ...
                          if isBQ c
                           then return ()
                           else throwErrorPackratM "isBQ c" "not match"
                          v <- dv_variableM
                          return ()
                          if True then return () else throwErrorPackratM "True" "not match"
                          xx102_102 <- dvCharsM
                          ...
                          if isBQ c_
                           then return ()
                           else throwErrorPackratM "isBQ c_" "not match"
...
p_opTail = foldl1 mplus [do xx105_105 <- dvCharsM
                            let c = xx105_105
                            if isOpTailChar c
                             then return ()
...
p_hsExp = foldl1 mplus [do e <- dv_hsExp1M
                        ...
                        do e <- dv_hsExp1M
                           ...
                           if True then return () else throwErrorPackratM "True" "not match"
                           return (toEx e)]
p_hsExp1 = foldl1 mplus [do xx106_106 <- dvCharsM
                            case xx106_106 of
                                '(' -> return ()
                                _ -> throwErrorPackratM "'('" "not match pattern"
                            let '(' = xx106_106
                            return ()
                            if True then return () else throwErrorPackratM "True" "not match"
                            xx107_107 <- papOptional (foldl1 mplus [do e <- dv_hsExpTypM
                                                                       return ()
                                                                       if True
                                                                        then return ()
                                                                        else throwErrorPackratM "True" "not match"
                            ...
                            dv_spacesM >> return ()
                            if True then return () else throwErrorPackratM "True" "not match"
                            xx108_108 <- papOptional (foldl1 mplus [do e <- dv_hsExpTypM
                                                                       return ()
                                                                       if True
                                                                        then return ()
                                                                        else throwErrorPackratM "True" "not match"
...
p_hsType = foldl1 mplus [do t <- dv_hsType1M
                         ...
                         do t <- dv_hsType1M
                            ...
                            if True then return () else throwErrorPackratM "True" "not match"
                            return (toTyp t)]
p_hsType1 = foldl1 mplus [do xx122_122 <- dvCharsM
                             case xx122_122 of
                                 '[' -> return ()
                                 _ -> throwErrorPackratM "'['" "not match pattern"
                             let '[' = xx122_122
...
p_integer = foldl1 mplus [do dh <- dv_digitM
                             return ()
                             if True then return () else throwErrorPackratM "True" "not match"
                             xx133_133 <- list (foldl1 mplus [do d <- dv_digitM
                                                                 return ()
                                                                 if True
                                                                  then return ()
                                                                  else throwErrorPackratM "True" "not match"
...
p_alpha = foldl1 mplus [do u <- dv_upperM
                        ...
                        do d <- dv_digitM
                           ...
                           if True then return () else throwErrorPackratM "True" "not match"
                           return d]
p_upper = foldl1 mplus [do xx134_134 <- dvCharsM
                           let u = xx134_134
                           if isUpper u
                            then return ()
                            else throwErrorPackratM "isUpper u" "not match"
                           return u]
p_lower = foldl1 mplus [do xx135_135 <- dvCharsM
                           let l = xx135_135
                           if isLowerU l
                            then return ()
                            else throwErrorPackratM "isLowerU l" "not match"
                           return l]
p_digit = foldl1 mplus [do xx136_136 <- dvCharsM
                           let d = xx136_136
                           if isDigit d
                            then return ()
...
p_spaces = foldl1 mplus [do dv_spaceM >> return ()
                            ...
                            return (),
                         do return ()]
p_space = foldl1 mplus [do xx137_137 <- dvCharsM
                           let s = xx137_137
                           if isSpace s
                            then return ()
                            else throwErrorPackratM "isSpace s" "not match"
                           return (),
                        do xx138_138 <- dvCharsM
                           case xx138_138 of
                               '-' -> return ()
                               _ -> throwErrorPackratM "'-'" "not match pattern"
                           let '-' = xx138_138
                        ...
                        do dv_commentM >> return ()
                           if True then return () else throwErrorPackratM "True" "not match"
                           return ()]
p_notNLString = foldl1 mplus [do ddd140_140 <- get
                                 ...
                                 return (cons c s),
                              do return emp]
p_nl = foldl1 mplus [do xx142_142 <- dvCharsM
                        case xx142_142 of
                            '\n' -> return ()
                            _ -> throwErrorPackratM "'\\n'" "not match pattern"
                        let '\n' = xx142_142
                        ...
                        if True then return () else throwErrorPackratM "True" "not match"
                        return ()]
p_comment = foldl1 mplus [do xx143_143 <- dvCharsM
                             case xx143_143 of
                                 '{' -> return ()
                                 _ -> throwErrorPackratM "'{'" "not match pattern"
                             let '{' = xx143_143
                             ...
                             if True then return () else throwErrorPackratM "True" "not match"
                             ddd145_145 <- get
                             flipMaybe (do xx146_146 <- dvCharsM
                                           case xx146_146 of
                                               '#' -> return ()
                                               _ -> throwErrorPackratM "'#'" "not match pattern"
                                           let '#' = xx146_146
...
p_comments = foldl1 mplus [do dv_notComStrM >> return ()
                           ...
                           do dv_notComStrM >> return ()
                              if True then return () else throwErrorPackratM "True" "not match"
                              return ()]
p_notComStr = foldl1 mplus [do ddd147_147 <- get
                               ...
                               return (),
                            do return ()]
p_comEnd = foldl1 mplus [do xx150_149 <- dvCharsM
                            case xx150_149 of
                                '-' -> return ()
                                _ -> throwErrorPackratM "'-'" "not match pattern"
                            let '-' = xx150_149
