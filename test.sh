...
runhaskell -isrc -Wall src/papillon test/peg/testParen.papillon > tmp/testParen.hs && \
...
runhaskell -isrc -Wall src/papillon test/peg/testType.papillon > tmp/testType.hs && \
