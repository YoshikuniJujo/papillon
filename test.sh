...
runhaskell -isrc -Wall bin/papillon test/peg/simple.papillon tmp/ && \
...
echo
echo arith.papillon
runhaskell -isrc -Wall bin/papillon test/peg/arith.papillon tmp/ && \
...
echo
echo test.papillon
runhaskell -isrc -Wall bin/papillon test/peg/test.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/testChar.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/otherTypes.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/testNotAfter.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/parseError.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/testZoi.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/testList.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/testParen.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/testType.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/testOp.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/testListLit.papillon tmp/ && \
...
runhaskell -isrc -Wall bin/papillon test/peg/testPatOp.papillon tmp/ && \
